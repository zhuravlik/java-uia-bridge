...
import zhuravlik.automation.jna.conditions.raw.IUIAutomationOrCondition;
...
public class OrCondition extends Condition {
    public OrCondition(Condition first, Condition second) throws Exception {
        PointerByReference result = new PointerByReference();
        IUIAutomation iua = UIAObject.getRootOleObject();
        
        iua.CreateOrCondition(
        ...
        rawCondition = iu2.queryInterface(IUIAutomationOrCondition.class);
    }    
}
